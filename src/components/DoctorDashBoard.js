  ...
  const dashboardActions = [
    {
      title: "View Profile",
      icon: "fas fa-user-md",
      onClick: () => navigate(`/doctor/${hhNumber}/viewdoctorprofile`),
        ...
        <div className="text-center mb-16">
          ...
          {doctorDetails && (
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">
              Welcome, <span className="font-bold text-transparent bg-clip-text bg-gradient-to-r from-yellow-500 to-orange-600">{doctorDetails[1]}</span>
            </p>
          )}
        </div>
